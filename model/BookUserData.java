...
public final class BookUserData {
   ...
   public BookUserData(final long bookId, final long rating, final boolean read, final String blurb, final long bookmark) {
      this.bookId = bookId;
      this.rating = rating;
      this.read = read;
      this.blurb = blurb;
   ...
   public int hashCode() {
      ...
      result = prime * result + (int) (this.bookmark ^ (this.bookmark >>> 32));
      return result;
   }
   ...
   public boolean equals(Object obj) {
      ...
      if (this.bookmark != other.bookmark) {
         return false;
      }
      return true;
   }
