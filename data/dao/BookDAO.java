...
public class BookDAO implements DAO<Book> {
   ...
   private static final String BOOK_INSERT =
            "insert into " + DataConstants.BOOK_TABLE + "(" + DataConstants.ISBN10 + "," + DataConstants.ISBN13 + ","
                     ...
                     + DataConstants.DATEPUB + "," + DataConstants.FID + ") values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
      ...
      if ((b != null) && (b.title != null)) {
         ...
         try {
            ...
            if (bookId > 0) {
               ...
               // insert bookuserdata
               BookUserData newBookUserData = new BookUserData(bookId, b.bookUserData.rating, b.bookUserData.read, b.bookUserData.blurb, b.bookUserData.bookmark);
   ...
   public void updateFolder(final Book b, long fid){
      if((b != null) && (b.id != 0)){
         db.beginTransaction();
         try {
            ...
            values.put(DataConstants.FID, fid);
   ...
   public void update(final Book b) {
      if ((b != null) && (b.id != 0)) {
         ...
         try {
            ...
            BookUserData newBookUserData = new BookUserData(b.id, b.bookUserData.rating, b.bookUserData.read, b.bookUserData.blurb, b.bookUserData.bookmark);
            bookUserDataDAO.insert(newBookUserData);
   ...
   private Book buildBookFromFullQueryCursor(final Cursor c) {
      ...
      if (!c.isClosed()) {
         ...
         if (userData != null) {
            ...
            b.bookUserData.bookmark = userData.bookmark;
         }
      }
      return b;
   }
