...
public class BookUserDataDAO implements DAO<BookUserData> {
   ...
   private static final String BOOKUSERDATA_INSERT =
            "insert into " + DataConstants.BOOKUSERDATA_TABLE + "(" + DataConstants.BOOKID + ","
                     + DataConstants.READSTATUS + "," + DataConstants.RATING + "," + DataConstants.BOOKMARK + "," + DataConstants.BLURB
                     + ") values (?, ?, ?, ?, ?)";
   ...
   public static void onCreate(SQLiteDatabase db) {
      ...
      sb.append(DataConstants.BOOKMARK + " INTEGER, ");
   ...
   public BookUserData select(final long id) {
      ...
      Cursor c =
               db.query(DataConstants.BOOKUSERDATA_TABLE, new String[] { DataConstants.READSTATUS,
                        DataConstants.RATING, DataConstants.BLURB, DataConstants.BOOKMARK }, DataConstants.BOOKUSERDATAID + " = ?",
   ...
   public BookUserData selectByBookId(final long bookId) {
      ...
      Cursor c =
               db.query(DataConstants.BOOKUSERDATA_TABLE, new String[] { DataConstants.READSTATUS,
                        DataConstants.RATING, DataConstants.BLURB, DataConstants.BOOKMARK }, DataConstants.BOOKID + " = ?",
   ...
   public long insert(final BookUserData b) {
      ...
      bookUserDataInsertStmt.bindLong(4, b.bookmark);
      Log.d("Bookmark", "Insert " + String.valueOf(b.bookmark));
      if (b.blurb != null) {
         bookUserDataInsertStmt.bindString(5, b.blurb);
      }
      try {
   ...
   public void update(final BookUserData b) {
      ...
      if (existingData == null) {
         ...
         Log.d("Bookmark", "Update " + String.valueOf(b.bookmark));
         ...
         values.put(DataConstants.BOOKMARK, b.bookmark);
