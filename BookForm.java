...
public class BookForm extends TabActivity {
   ...
   public void onCreate(final Bundle savedInstanceState) {
      ...
      //bookDatePub2 = (Button) findViewById(R.id.bookdatepub2);
      bookPublisher = (EditText) findViewById(R.id.bookpublisher);


      final Calendar c = Calendar.getInstance();
      pubYear = c.get(Calendar.YEAR);
      pubMonth = c.get(Calendar.MONTH);
      pubDay = c.get(Calendar.DAY_OF_MONTH);

      bookPubDate = (EditText) findViewById(R.id.bookPubDate);
      bookPubDate.setOnClickListener(new OnClickListener() {
         @Override
         public void onClick(View v) {
            DatePickerDialog datePickerDialog = new DatePickerDialog(BookForm.this, android.R.style.Theme_Material_Dialog,
                    new DatePickerDialog.OnDateSetListener() {
                       ...
                       public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                          ...
                          cal.set(Calendar.YEAR, pubYear);
                          cal.set(Calendar.MONTH, pubMonth);
                          cal.set(Calendar.DAY_OF_MONTH, pubDay);

                          bookPubDate.setText(DateUtil.format(new Date(cal.getTimeInMillis())));
                       }
      ...
      captureCoverButton = (Button) findViewById(R.id.bookformcapturecoverbutton);
      captureCoverButton.setOnClickListener(new OnClickListener() {
         @Override
         public void onClick(View v) {
            try {
               ...
               Toast.makeText(BookForm.this, "No camera found", Toast.LENGTH_SHORT).show();
            }
         }
      });
   ...
   public void onActivityResult(final int requestCode, final int resultCode, final Intent data) {
      ...
      if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
         ...
         Book book = application.selectedBook;
         if (book != null) {
            application.imageManager.storeBitmap(imageBitmap, book.title, book.id);
         }
         Toast.makeText(BookForm.this, "Picture Taken", Toast.LENGTH_SHORT).show();
      }
   }
      ...
      if (book != null) {
         ...
         if (book.datePubStamp > 0) {
            ...
            try {
               ...
               pubDay = cal.get(Calendar.DAY_OF_MONTH);
